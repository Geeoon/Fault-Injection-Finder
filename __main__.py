...
# finder = FaultInjectionFinder('./binaries/pc_test_complex.bin', input=b'0' * 4, desired_pc=0x12345678)
# finder = FaultInjectionFinder('./binaries/sha256.bin', input=b'1' * 16)
finder = FaultInjectionFinder('./binaries/aes_ecb.bin', input=b'a' * 16, desired_pc=0x12345678)
