...
main:
.Lfunc_begin0:
	.file	1 "/home/main/Documents/school/Fault-Injection-Finder/targets/timspm0l2228/source" "chacha20/main.c"
	.loc	1 7 0                           @ chacha20/main.c:7:0
	.fnstart
...
@ %bb.0:
	...
	movs	r4, #0
.Ltmp0:
	.loc	1 8 18 prologue_end             @ chacha20/main.c:8:18
	str	r4, [sp, #448]
.Ltmp1:
	.loc	1 9 9                           @ chacha20/main.c:9:9
	ldr	r0, [sp, #448]
.Ltmp2:
	.loc	1 9 9 is_stmt 0                 @ chacha20/main.c:9:9
	cmp	r0, #0
	beq	.LBB0_2
@ %bb.1:
.Ltmp3:
	.loc	1 9 16                          @ chacha20/main.c:9:16
	bl	pwned
.Ltmp4:
.LBB0_2:
	.loc	1 11 19 is_stmt 1               @ chacha20/main.c:11:19
	ldr	r0, .LCPI0_0
	add	r7, sp, #416
	mov	r1, r7
	ldm	r0!, {r2, r3, r5, r6}
	...
	ldm	r0!, {r2, r3, r5, r6}
	stm	r1!, {r2, r3, r5, r6}
	.loc	1 12 19                         @ chacha20/main.c:12:19
	str	r4, [sp, #412]
	str	r4, [sp, #408]
	str	r4, [sp, #404]
	add	r6, sp, #212
	movs	r2, #192
	.loc	1 16 13                         @ chacha20/main.c:16:13
...
.Ltmp5:
	...
	.loc	1 0 13 is_stmt 0                @ chacha20/main.c:0:13
	movs	r0, #1
	.loc	1 20 5 is_stmt 1                @ chacha20/main.c:20:5
...
.Ltmp6:
	.loc	1 23 5                          @ chacha20/main.c:23:5
	mov	r0, r5
	mov	r1, r6
	ldr	r2, [sp, #20]                   @ 4-byte Reload
	bl	chacha20_xor
.Ltmp7:
	.loc	1 26 5                          @ chacha20/main.c:26:5
	...
	bl	chacha20_init_context
.Ltmp8:
	.loc	1 29 5                          @ chacha20/main.c:29:5
	mov	r0, r5
	mov	r1, r6
	ldr	r2, [sp, #20]                   @ 4-byte Reload
	bl	chacha20_xor
.Ltmp9:
	.loc	1 31 5                          @ chacha20/main.c:31:5
	mov	r0, r4
	.loc	1 31 5 epilogue_begin is_stmt 0 @ chacha20/main.c:31:5
	add	sp, #452
	pop	{r4, r5, r6, r7, pc}
.Ltmp10:
	.p2align	2
@ %bb.3:
	.loc	1 0 5                           @ chacha20/main.c:0:5
.LCPI0_0:
