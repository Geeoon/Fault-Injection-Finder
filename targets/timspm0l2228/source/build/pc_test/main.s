...
main:
.Lfunc_begin0:
	.file	1 "/home/main/Documents/school/Fault-Injection-Finder/targets/timspm0l2228/source" "pc_test/main.c"
	.loc	1 7 0                           @ pc_test/main.c:7:0
	.fnstart
...
.Ltmp0:
	.loc	1 8 5 prologue_end              @ pc_test/main.c:8:5
	bl	init_device
.Ltmp1:
	.loc	1 0 5 is_stmt 0                 @ pc_test/main.c:0:5
	movs	r0, #0
	.loc	1 9 18 is_stmt 1                @ pc_test/main.c:9:18
	str	r0, [sp, #4]
.Ltmp2:
	.loc	1 10 9                          @ pc_test/main.c:10:9
	ldr	r0, [sp, #4]
.Ltmp3:
	.loc	1 10 9 is_stmt 0                @ pc_test/main.c:10:9
	cmp	r0, #0
	beq	.LBB0_2
@ %bb.1:
.Ltmp4:
	.loc	1 10 16                         @ pc_test/main.c:10:16
	bl	pwned
.Ltmp5:
.LBB0_2:
	.loc	1 0 16                          @ pc_test/main.c:0:16
	movs	r4, #0
	mov	r1, sp
	movs	r2, #4
	.loc	1 12 5 is_stmt 1                @ pc_test/main.c:12:5
	mov	r0, r4
	bl	_read
.Ltmp6:
	.loc	1 14 13                         @ pc_test/main.c:14:13
	ldr	r0, [sp]
	.loc	1 14 12 is_stmt 0               @ pc_test/main.c:14:12
	mvns	r0, r0
	.loc	1 14 10                         @ pc_test/main.c:14:10
	str	r0, [sp]
	.loc	1 15 5 is_stmt 1                @ pc_test/main.c:15:5
	blx	r0
.Ltmp7:
	.loc	1 16 5                          @ pc_test/main.c:16:5
	mov	r0, r4
	.loc	1 16 5 epilogue_begin is_stmt 0 @ pc_test/main.c:16:5
	add	sp, #8
	pop	{r4, pc}
.Ltmp8:
.Lfunc_end0:
